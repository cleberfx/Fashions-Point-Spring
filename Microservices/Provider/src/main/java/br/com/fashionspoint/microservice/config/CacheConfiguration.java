package br.com.fashionspoint.microservice.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("Provider");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("Provider");
        ...
        config.getMapConfigs().put("br.com.fashionspoint.microservice.domain.*", initializeDomainMapConfig(jHipsterProperties));
