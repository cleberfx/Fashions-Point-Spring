...
RUN sudo add-apt-repository ”deb [arch=amd64] https://archive.cloudera.com/cdh5/ubuntu/trusty/amd64/cdh trusty-cdh5 contribdeb-src https://archive.cloudera.com/cdh5/ubuntu/trusty/amd64/cdh trusty-cdh5 contrib”
